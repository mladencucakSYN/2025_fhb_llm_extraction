...
> Legacy document: this was the original generic project overview. For the current, Fusarium-focused structure, see `README.md` and `dev/doc/main/system_description.md`.
